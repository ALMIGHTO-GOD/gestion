<?php ob_start(); // <-- ¡ESTA ES LA LÍNEA NUEVA!

// --- 1. EL GUARDIÁN Y LA SESIÓN ---
session_start(); 
// ... (el resto de tu archivo header.php)
...
// --- 3. CONEXIÓN A LA BD ---
// (La necesitamos en casi todas las páginas, así que la ponemos aquí)
$servidor = "127.0.0.1";
$usuario_db = "root"; 
$pass_db = "";        
...
if ($conn->connect_error) {
    // Si falla la BD, guardamos el error para mostrarlo después
